...
public class SceneView extends View {
    ...
    public SceneView(Context context) {
        ...
        //load sprite
        if (bmSprite == null)
            bmSprite = BitmapFactory.decodeResource(getResources(), R.drawable.pic2);

        //init random set of points
        aPoints.add(new PointF(10f, 300f));
        aPoints.add(new PointF(700f, 700f));
        aPoints.add(new PointF(2400f, 900f));
        aPoints.add(new PointF(2500f, 1400f));
        //init smooth curve
